...
var BirdComponent = /** @class */ (function () {
    ...
    BirdComponent.prototype.cambiarTitulo = function () {
...
var NoteComponent = /** @class */ (function () {
    ...
    NoteComponent.prototype.onAddNote = function (form) {
    ...
    NoteComponent.prototype.onCopyNote = function (form) {
        form.body.select();
        document.execCommand("copy");
    };
    NoteComponent.prototype.onDeleteNote = function (form) {
        form.reset();
    };
    NoteComponent.prototype.onCopyNotes = function (text) {
        text.disabled = false;
        text.select();
        document.execCommand("copy");
        text.disabled = true;
    };
    NoteComponent.prototype.onDelete = function (note) {
        note.visible = false;
...
var Note = /** @class */ (function () {
    function Note(title, body, visible) {
        this.title = title;
        this.body = body;
